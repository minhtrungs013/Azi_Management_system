        ...
        <div >
            <div className='mb-3'>
                ...
                <div className="flex space-x-2 justify-between">
                    <div className='flex'>
                        <Link href={`/projects/${project?._id}`} className="px-4 py-2 bg-white border rounded-md flex items-center mr-2">Sprint<ArrowDownWideNarrow className="w-4 h-4 ml-2" /></Link>
