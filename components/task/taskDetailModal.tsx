...
import { CaseSensitive, Edit, FileCheck2, Power, Save, Send, X } from "lucide-react";
                        ...
                        <div className="grid grid-cols-3 gap-4 my-5 ">
                            ...
                            <div className="col-start-3 col-span-3 ">
                                <div className="mb-2">
                                    ...
                                    <div className="ml-2 py-2">
                                        <div className="flex items-center mb-2  text-red-700">
                                            Reporter: <input type="text" className="ml-2 text-sm text-black w-full border border-gray-300 rounded-md p-2" disabled={true} placeholder="" defaultValue={task?.reporter?.firstname + " " + task?.reporter?.lastname} />
                                        </div>
