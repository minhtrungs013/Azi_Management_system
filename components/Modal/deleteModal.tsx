...
const DeleteModal: React.FC<DeleteModalProps> = ({ closeModal, title, handleDelete, body }) => {
            ...
            <div className="py-3 sm:max-w-xl sm:mx-auto">
                <div className="relative px-4 py-5 bg-white shadow-lg sm:rounded-xl sm:p-10">
                    <div className="min-w-[500px] mx-auto">
                        <h1 className="text-2xl font-semibold text-gray-700 mb-8 flex items-center "> <TriangleAlert className="h-10 w-10 mr-3 text-red-400" /> {title}</h1>
